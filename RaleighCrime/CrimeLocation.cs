...
namespace RaleighCrime
{
    ...
    //times each crime was committed in a particular geographic location
    //and return a rank set of the highest-crime areas for geographies up to
    //3 decimal points.
    public class CrimeLocation : MapperBase
    {
    ...
    public class TopCrimeLocations : ReducerCombinerBase
    {
